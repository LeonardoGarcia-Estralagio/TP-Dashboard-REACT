    ...
    const getGenres = async () => {
        try {
            let response = await fetch(
                `${import.meta.env.VITE_APP_API_URL_BASE}/genres`
            );
            ...
            <CardBody>
                <Form className="row" onSubmit={formik.handleSubmit}>
                    ...
                    <Form.Group className="mb-3 col-12">
                        ...
                        <Form.Select
                            className={`form-control ${formik.errors.genre_id && 'is-invalid'}`}
                            name="genre_id"
                            value={formik.values.genre_id}
                            onChange={formik.handleChange}
                        >
                            <option hidden value="">Seleccione el género</option>
                            {
                    ...
                    <Button type="button" onClick={handleReset} variant="outline-dark" className="mt-5">
                        Cancelar
                    </Button>
